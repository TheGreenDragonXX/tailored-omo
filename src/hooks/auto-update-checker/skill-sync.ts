 ...
 *
 * How to populate:
 * 1. Download previous releases of the npm package: `npm pack tailored-omo@<version>`
...
/**
 * Acquires a simple lock under .tailored-omo.
...
export function syncBundledSkillsFromPackage(
  ...
  const manifestDir = path.join(getConfigDir(), '.tailored-omo');
