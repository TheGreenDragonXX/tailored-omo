...
describe('auto-update-checker/checker', () => {
  ...
  describe('findPluginEntry', () => {
    test('detects latest version entry', async () => {
      ...
      expect(entry?.entry).toBe('tailored-omo');
  ...
  "note": "{ [ ] }",
  "other": { "plugin": [["tailored-omo@0.1.0", { "__ohMyOpencodeSlimManagedByInstaller": true }]] },
  "plugin": [["tailored-omo@0.2.0", { "__ohMyOpencodeSlimManagedByInstaller": true }]],
  "plugin": [
    [ /* tuple comment */ "tailored-omo@1.2.3", { "__ohMyOpencodeSlimManagedByInstaller": true, "keep": "[{}]" } ],
    ["tailored-omo@1.2.3", { "__ohMyOpencodeSlimManagedByInstaller": false, "__ohMyOpencodeSlimManagedByInstaller": true }],
    ["tailored-omo@1.2.3", { "__ohMyOpencodeSlimManagedByInstaller": "true" }],
    ["tailored-omo\\u00401.2.3", { "__ohMyOpencodeSlimManagedByInstall\\u0065r": true }],
    "tailored-omo@1.2.3",
    ["tailored-omo@1.2.3", { "nested": { "__ohMyOpencodeSlimManagedByInstaller": true } }]
  ]
}`,
        ],
        [
      ...
      expect(files.get('/mock/config/opencode.json')).toContain(
        '"tailored-omo@1.2.4", { "__ohMyOpencodeSlimManagedByInstall\\u0065r": true }',
      );
      expect(files.get('/mock/config/opencode.json')).toContain(
        '"tailored-omo@0.1.0", { "__ohMyOpencodeSlimManagedByInstaller": true }',
      );
      expect(files.get('/mock/config/opencode.json')).toContain(
        '"tailored-omo@0.2.0", { "__ohMyOpencodeSlimManagedByInstaller": true }',
      );
      expect(files.get('/mock/config/opencode.json')).toContain(
        '"tailored-omo@1.2.3", { "__ohMyOpencodeSlimManagedByInstaller": "true" }',
      );
