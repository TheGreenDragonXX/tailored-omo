 ...
 * Users can override per-agent via tailored-omo.json agents.<name>.model.
 */
...
- Prefer dedicated file tools for normal code work: glob/grep for discovery, read for file contents, and edit/write/apply_patch for targeted source changes.
...
- READ-ONLY: inspect and report; do not modify files.
- Use glob/grep for discovery and read for file contents.
